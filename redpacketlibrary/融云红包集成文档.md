...
* libs ：
* 1、redpacket3.1.1是集成红包功能所依赖的jar包。
...
* 3、GetUserInfoCallback 根据用户id获取用户信息接口回调
* 4、SetUserInfoCallback 设置用户信息接口回调
* message ：
...
*在SealAppContext实现setGetUserInfoCallback和setGroupMemberListener*
